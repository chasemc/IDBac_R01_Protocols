...
Prepare the following solution and autoclave to sterilize:
...
Allow the bacteria to grow for a period of 7-days. (e.g. Inoculate agar-plate on Monday -> put onto MALDI plate the next Monday)
