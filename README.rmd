...
## Document sample positions on MALDI plate 
If you haven't already, download the Excel template for renaming raw data files [here.]() 

- Using the Excel®/OpenOffice™ template mentioned above, simply enter your sample names into the spreadsheet .
...
<center>
```{r, echo = F, out.width = "400px", fig.cap = "When applying bacteria you want your spot to look like the the spots in columns 1 to 2. Column 2 has a little too much, and 3 has too much cell material"}
